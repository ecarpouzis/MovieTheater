...
function ArcadeNavContent({ userData, onUserLoggedIn, setSettingsModalOpen, setAdminModalOpen }) {
  ...
  const updateParam = useSectionParams("/arcade");
  ...
  return (
    <>
      ...
      <div className="nav-search-tools" style={{ padding: "8px 16px 24px", color: "white" }}>
        ...
        <Select mode="multiple" allowClear style={{ width: "100%" }} value={activeSystems}
          ...
          classNames={{ popup: { root: "nav-dropdown" } }} getPopupContainer={getPopupContainer} />
        ...
        <Select style={{ width: "100%" }} value={activePlayers} onChange={(v) => updateParam("players", v)}
          options={playerOptions} classNames={{ popup: { root: "nav-dropdown" } }} getPopupContainer={getPopupContainer} />
        ...
        <Select style={{ width: "100%" }} value={activeVariant} onChange={(v) => updateParam("variant", v === "all" ? "" : v)}
          options={modOptions} classNames={{ popup: { root: "nav-dropdown" } }} getPopupContainer={getPopupContainer} />

        <span style={inputLabelStyle}>RetroAchievements</span>
        <Select style={{ width: "100%" }} value={activeRa} onChange={(v) => updateParam("ra", v)}
          options={raOptions} classNames={{ popup: { root: "nav-dropdown" } }} getPopupContainer={getPopupContainer} />
