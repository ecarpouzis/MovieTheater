  ...
  return (
    <div className="bka-tab">
      <section className="bka-card">
        <header className="bka-card-head"><div className="bka-card-text"><h3 className="bka-card-title">Kid-clear tags</h3><p className="bka-card-desc">A series appears in Kids only when it carries one of these tags (and nothing above the ceiling). Comics carry <code>audience:all-ages</code>; books carry <code>audience:children</code>. Changes reach the Kids view on its next open.</p></div></header>
