...
export const SECTIONS: SectionDef[] = [
  ...
  },
  {
    ...
    tabs: [
      ...
      // The RetroAchievements hub, as the canvas draws it: a tab, not a bar button. It renders a
      // PAGE (App.js) like every other tab here — it used to render the lobby with the hub open as a
      // dialog over it, which meant choosing Trophies paid for the whole ~13k-card lobby behind it.
